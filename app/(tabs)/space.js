              ...
              {tab === "contributions" && (
                <View className="items-center space-y-4 mt-4">
                  ...
                  <View className="w-[200px] h-[200px] border-2 rounded-xl justify-center items-center">
                    ...
                    <Text className="text-[16px] font-bold">{Number(waste.carbon).toFixed(2)} Liter</Text>
                  </View>
                  <View className="w-[200px] h-[200px] border-2 rounded-xl justify-center items-center">
                    <Image className="w-[82px] h-[82px]" source={require("@assets/images/water-icon.png")} />
                    <Text className="text-[16px] font-bold">Water</Text>
                    <Text className="text-[16px] font-bold">{Number(waste.water).toFixed(2)} Liter</Text>
                  </View>
                  <View className="w-[200px] h-[200px] border-2 rounded-xl justify-center items-center">
                    ...
                    <Text className="text-[16px] font-bold">{Number(waste.textile).toFixed(2)} KG</Text>
                  </View>
                </View>
              )}
            </View>
